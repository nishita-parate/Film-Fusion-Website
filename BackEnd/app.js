...
async function getFavouritesMovies(){
  const resp = localStorage.getItem(`https://api.themoviedb.org/3/favourites/all/day?api_key=${API_KEY}`)
}
async function removeFavouritesMovies(){
  localStorage.removeItem(`https://api.themoviedb.org/3/favourites/all/day?api_key=${API_KEY}`)
}
